...
namespace CombatExtended
{
    public class Graphic_Smoke : Graphic_Gas
    {
        ...
        public override void DrawWorker(Vector3 loc, Rot4 rot, ThingDef thingDef, Thing thing, float extraRotation)
        {
            ...
            float angle = Compatibility.Random.Range(0, 360) + smoke.graphicRotation;
            Vector3 pos = thing.TrueCenter() + new Vector3(Compatibility.Random.Range(-0.45f, 0.45f), 0f, Compatibility.Random.Range(-0.45f, 0.45f));
            Vector3 s = new Vector3(Compatibility.Random.Range(0.8f, 1.2f) * this.drawSize.x, 0f, Compatibility.Random.Range(0.8f, 1.2f) * this.drawSize.y);
